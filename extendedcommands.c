...
{
    static char* headers[] = {  "从sd卡上的.zip文件应用更新",
                                "",
                                NULL
    };
    ...
    for (;;)
    {
        ...
        switch (chosen_item)
        {
            ...
            {
                if (confirm_selection("确定安装?", "对 - 安装 /sdcard/update.zip"))
...
void show_choose_zip_menu(const char *mount_point)
{
    ...
    sprintf(confirm, "对 - 安装 %s", basename(file));
...
void show_nandroid_restore_menu(const char* path)
{
    ...
    if (confirm_selection("确认还原?", "对 - 还原"))
...
int confirm_selection(const char* title, const char* confirm)
{
    ...
    char* confirm_headers[]  = {  title, "  这不能取消.", "", NULL };
...
void show_partition_menu()
{
    ...
    for (;;)
    {
        ...
        options[mountable_volumes+formatable_volumes] = "挂载USB储存设备";
...
void show_nandroid_advanced_restore_menu(const char* path)
{
    ...
    static char* advancedheaders[] = {  "选择镜像还原",
                                "",
                                "选择一个镜像还原",
                                "首先. 下一个菜单",
                                "你有更多选择.",
    ...
    static char* headers[] = {  "Nandroid高级还原",
                                "",
                                NULL
    };
    ...
    {
        case 0:
            if (confirm_selection(confirm_restore, "对 - 还原boot"))
                nandroid_restore(file, 1, 0, 0, 0, 0, 0);
            break;
        case 1:
            if (confirm_selection(confirm_restore, "对 - 还原系统"))
                nandroid_restore(file, 0, 1, 0, 0, 0, 0);
            break;
        case 2:
            if (confirm_selection(confirm_restore, "对 - 还原数据"))
                nandroid_restore(file, 0, 0, 1, 0, 0, 0);
            break;
        case 3:
            if (confirm_selection(confirm_restore, "对 - 还原缓存"))
                nandroid_restore(file, 0, 0, 0, 1, 0, 0);
            break;
        case 4:
            if (confirm_selection(confirm_restore, "对 - 还原sd-ext"))
                nandroid_restore(file, 0, 0, 0, 0, 1, 0);
            break;
        case 5:
            if (confirm_selection(confirm_restore, "对 - 还原wimax"))
    ...
    for (;;)
    {
        ...
        switch (chosen_item)
        {
            ...
            case 1:
            {
                ...
                if (confirm_selection( "确认清除?", "对 - 清除Dalvik缓存")) {
            ...
            case 2:
            {
                if (confirm_selection( "确认清除?", "对 - 清除电池调试记录数据"))
                    wipe_battery_stats();
                break;
            }
            case 3:
